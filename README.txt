Note: Please open in fullscreen.
...
UML Diagrams
	Class diagram
	[Character | ~name : String; ~health : int; ~currenthp : int; ~strength : int; ~intelligence : int; ~dexterity : int; ~defence : int; ~identifier : int; 	~defenceBuff : int; ~Race : Object; ~Class : Object; ~Equipment : Object | +Character(String, int, int, int, int, int); +toString() : String; +toName : String; 	+statMod(StatMod) : void; +attack(Character, Character) : void; +defend(Character) : void; +heal(Character) : void]

	[Race | ~name : String; ~stat1 : StatMod; ~stat2 : StatMod | +Race(String, StatMod, StatMod); +toString() : String]
